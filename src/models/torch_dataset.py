...
def collate_function(batch):
    ...
    tokenizer = AutoTokenizer.from_pretrained(CFG.text_encoder_name, model_max_length=128, use_fast=True)#"bert-base-uncased"
...
def collate_function_v2(batch):
    ...
    tokenizer = AutoTokenizer.from_pretrained(CFG.text_encoder_name, model_max_length=128)#"bert-base-uncased"
